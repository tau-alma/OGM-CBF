...
class RutMapNode  : public rclcpp::Node
{
  private:
    ...
    {
      cv_bridge::CvImagePtr front_image_ptr = cv_bridge::toCvCopy(_front_elevimg, sensor_msgs::image_encodings::MONO8);
      cv_bridge::CvImagePtr rear_image_ptr  = cv_bridge::toCvCopy(_rear_elevimg, sensor_msgs::image_encodings::MONO8);
    ...
    void tick_map()
    {
      ...
      if (_rear_elevimg && _front_elevimg) publish_image(ts);

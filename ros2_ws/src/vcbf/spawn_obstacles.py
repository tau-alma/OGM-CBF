...
def spawn_two_cars(
    ...
    base_spawn_data = [
        ("vehicle.mercedes.sprinter", (-42.0, 95.0, 0.5), -90, 1.0, 0.3, 3.0),
        ("vehicle.mercedes.sprinter", (-44.0, 88.0, 0.5), -90, 1.0, 0.3, 8.0),
        ("vehicle.mercedes.sprinter", (-47.0, 80.0, 0.5), -90, 1.0, 0.3, 3.0),  # uses defaults
    ]

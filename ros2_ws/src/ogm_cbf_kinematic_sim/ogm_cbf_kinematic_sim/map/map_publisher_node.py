...
class MapPublisherNode(Node):
    def __init__(self):
        ...
        self.map_path = os.path.join(os.path.dirname(__file__), '/home/golnaz/workspace/projects/work/OGM-CBF/ros2_ws/src/ogm_cbf_kinematic_sim/ogm_cbf_kinematic_sim/map/festia_map/Frame 36 (2).png')
